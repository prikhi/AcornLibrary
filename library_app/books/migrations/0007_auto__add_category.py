...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('books_category', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', blank=True, to=orm['books.Category'], null=True)),
    ...
    models = {
        ...
        'books.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'related_name': "'children'", 'blank': 'True', 'to': "orm['books.Category']", 'null': 'True'}),
